...
<Image src={banner} style="width:100%;height:auto;"  alt="Banner"/>
{/* <img src={banner.src} width='100%' alt='text' /> */}
...
One of the most exhilarating ways to experience nature is
 through hiking. Trekking through rugged mountain trails offers stunning views and a sense of accomplishment as you reach the summit. Whether it's the snow-capped peaks of the Himalayas or the rolling hills of the Appalachians, each mountain range has its own unique charm.
